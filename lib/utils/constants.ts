export const SITE_CONFIG = {
  ...
  analytics: {
    ...
    clarityId: "u0kc71tf0r", // Replace with actual Clarity ID
  },

  // Game iframe URL
  gameUrl: "https://games.crazygames.com/fr_FR/through-the-wall/index.html?v=1.344",
...
export const PRIMARY_KEYWORD = "through the wall";
